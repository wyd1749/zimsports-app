...
export const LEAGUES: LeagueConfig[] = [
  ...
  { id: 'ZIM',  name: 'Zimbabwe Premier Soccer League', shortName: 'Zim PSL', sport: 'football', flag: '🇿🇼', apiSource: 'api-sports', apiSportsId: 401, group: 'football' },
]
...
async function fetchApiSportsFootball(leagueId: number): Promise<ExternalGame[]> {
  ...
  const currentYear = 2024 // API-Sports free tier only supports up to 2024
